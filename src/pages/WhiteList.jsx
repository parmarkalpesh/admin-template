...
const Whitelist = () => {
  const [whitelistData, setWhitelistData] = useState([
    { phoneNumber: '+91 9999988888', label: 'Office', addedOn: '2024-06-01' },
    { phoneNumber: '+91 8888877777', label: 'Home', addedOn: '2024-05-28' },
  ]);
  ...
  const handleDelete = (index) => {
    setWhitelistData((prev) => prev.filter((_, i) => i !== index));
  };
